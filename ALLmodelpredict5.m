...
% PCR 21
%X_21 = X;
%X_6 = X(:,[1,21,20,7,12]); %(ky	Ts	Mw	PGV	Sa(1.3Ts)
...
%% GLM
S = load('./five_feat/models/GLMmodel.mat');
GLMmodel = S.GLMmodel;
Disp(:,1) = predict(GLMmodel,X_6);


%% PLSR
S = load('./five_feat/models/PLScoeff');
PLScoeff = S.PLScoeff;
[m,~] = size(X_21);
...
%% PCR
S = load('./five_feat/models/PCRcoeff');
PCRcoeff = S.PCRcoeff;
[m,~] = size(X_21);
...
S = load('./five_feat/models/BagBooMdl_6.mat');
...
S = load('./five_feat/models/KernMdl_21.mat');
...
S = load('./five_feat/models/plymdl2_6.mat');
plymdl2_6 = S.plymdl2_6;
Disp(:,12) = predict(plymdl2_6,X_6.^2);

S = load('./five_feat/models/plymdl3_6.mat');
plymdl3_6 = S.plymdl3_6;
Disp(:,13) = predict(plymdl3_6,X_6.^3);

S = load('./five_feat/models/plymdl4_6.mat');
